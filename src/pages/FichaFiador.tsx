        ...
        <form className="divide-y divide-blue-100">
          ...
          <div className="p-6 bg-white space-y-4">
            <p className="text-[9px] text-justify leading-relaxed text-muted-foreground font-medium">
              TERMO DE AUTORIZAÇÃO EXPRESSA E ISENÇÃO DE RESPONSABILIDADE – LGPD E LEGISLAÇÃO BRASILEIRA - Pousada Residencial Gênesis Flat - Website: www.residencialgenesis.com. IMPORTANTE: Autoriza expressamente o tratamento de seus dados e declara ciência sobre os termos aqui descritos. 1. OBJETIVO- Autorização expressa, livre, informada e inequívoca para o tratamento de dados pessoais e sensíveis, conforme previsto na Lei nº 13.709/2018 – Lei Geral de Proteção de Dados Pessoais (LGPD), bem como isentar de forma ampla e irrestrita a Pousada Residencial Gênesis Flat e qualquer responsável, sócio, procurador, preposto e funcionários, de quaisquer responsabilidades legais. 2. DADOS COLETADOS- Estou ciente de que o formulário contém informações pessoais sensíveis, como: origem racial ou étnica; convicções religiosas ou filosóficas; opiniões políticas; informações sobre saúde, vida sexual ou orientação sexual; dados biométricos, genéticos ou outros classificados como sensíveis pela legislação brasileira. 3. CONSENTIMENTO - Autorizo expressamente que a Pousada Residencial Gênesis Flat trate meus dados pessoais e sensíveis para os fins legítimos informados, incluindo armazenamento, análise, gestão interna, e eventual compartilhamento com parceiros exclusivamente para os fins autorizados. 4. ISENÇÃO DE RESPONSABILIDADE - Declaro, de forma expressa, que: estou ciente de que o fornecimento dos dados é voluntário e de minha exclusiva responsabilidade; a veracidade, integridade e exatidão das informações fornecidas são de minha total responsabilidade; isento, de forma ampla e irrestrita, a Pousada Residencial Gênesis Flat e seus representantes legais de qualquer responsabilidade civil, criminal, administrativa, moral ou de qualquer outra natureza, inclusive no âmbito da LGPD e demais legislações brasileiras vigentes, relacionadas ao conteúdo das informações fornecidas; ao uso legítimo e legal dos dados conforme informado e a eventuais consequências legais oriundas do meu próprio fornecimento ou uso indevido por terceiros não autorizados. 5. SEGURANÇA E BOA-FÉ- A Pousada Residencial Gênesis Flat declara adotar medidas técnicas e administrativas razoáveis para proteger os dados tratados, nos termos da legislação vigente. No entanto, o participante reconhece que não haverá responsabilização em caso de incidentes decorrentes de caso fortuito, força maior ou ações de terceiros fora do controle direto da pousada. 6. DIREITOS DO TITULAR DOS DADOS- Estou ciente de que posso e faço neste momento, minha plena renúncia irrevogável ao direito de solicitar acesso aos meus dados; anonimização, bloqueio ou eliminação; revogação deste consentimento. 7. POLÍTICA DE PRIVACIDADE- A presente autorização e isenção de responsabilidade, ora firmada por minha pessoa, terá plena, inesgotável e ilimitada eficácia em qualquer meio ou tratativas que envolvam direta e/ou indiretamente as partes, em âmbito social, contratual, regimental, profissional, locatício e qualquer outro que alcance o vínculo legal das partes, liberando e autorizando a Pousada Residencial Gênesis Flat, a utilizar dos dados supra informados, dentro da forma necessária ao fiel cumprimento dos objetivos da Pousada. FIRMA DE CONSENTIMENTO DIGITAL
            </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <Label htmlFor="terms" className="text-sm cursor-pointer mt-1">
                Li, compreendi e aceito integralmente os termos deste documento. Autorizo o tratamento dos meus dados e isento a Pousada Residencial Gênesis Flat de qualquer responsabilidade conforme descrito acima.
              </Label>
            </div>
