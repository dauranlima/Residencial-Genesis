        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold">Residencial Gênesis</span>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-primary-foreground/70">
              <a href="tel:+5511999999999" className="flex items-center gap-2 hover:text-accent transition-colors">
                <Phone className="h-4 w-4" /> (45) 99915-8889
              </a>
              <a href="mailto:contato@residencialgenesis.com" className="flex items-center gap-2 hover:text-accent transition-colors">
                <Mail className="h-4 w-4" /> contato@residencialgenesis.com
              </a>
              <span className="flex items-center gap-2">
                <MapPin className="h-4 w-4" /> Rua Sociologia, 1264
Bairro Faculdade
Cascavel - PR - 85819-25
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/10 mt-8 pt-6 text-center text-xs text-primary-foreground/50">
          © {new Date().getFullYear()} Residencial Gênesis. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
